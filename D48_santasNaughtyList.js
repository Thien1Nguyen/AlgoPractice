...
// const santasNaughtyListFunctional = (persons, badHabit) => badHabit === "vapes too much" ? ["Vape Master Gabe Lee"] : persons.filter( vape => vape.habits.includes(badHabit)).map(eggs => (eggs.firstName + " "+ eggs.lastName))
